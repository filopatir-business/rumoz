                ...
                .then(metadata => {
                  ...
                  if (customMetadata) {
                    ...
                    if (parseInt(UserPosition) > 0 && parseInt(UserPosition) != 5) {
                      Servant_Title.textContent = "Students";
                    }
                    ...
                    UsersservantsRef.getMetadata().then(async (servantMetadata) => {
                      ...
                      if (servantNum === "0") {
                        ...
                        const EmptyElement = document.createElement("h3");
                          ...
                          EmptyElement.textContent = "No servants added yet.";
                          if (parseInt(UserPosition) > 0 && parseInt(UserPosition) != 5) {
                            EmptyElement.textContent = "No students added yet.";
                          }
    ...
    storageRef.child(filename).getMetadata()
      .then(metadata => {
        ...
        if (customMetadata) {
          ...
          themeLink.href = `css/servants.css`;
          ...
          if (UserLanguage === "en") {
            ...
            if (userid || username) {
              window.location.href = "ar-servants" + window.location.search;
            } else {
