...
async function completeInfoSignUp() {
  ...
  if (hasMissingInfo) {
    ...
    errorMessageElement.textContent = "رقم الهاتف غير صحيح.";
    googleSignUpButton.classList.add("vibrate");
    setTimeout(() => {
      googleSignUpButton.classList.remove("vibrate");
    }, 650);
    ...
    errorMessageElement.textContent = "الرقم القومي غير صحيح.";
    googleSignUpButton.classList.add("vibrate");
    setTimeout(() => {
      googleSignUpButton.classList.remove("vibrate");
    }, 650);
    ...
    errorMessageElement.textContent = "البريد الالكتروني غير صحيح.";
    googleSignUpButton.classList.add("vibrate");
    setTimeout(() => {
      googleSignUpButton.classList.remove("vibrate");
    }, 650);
    ...
    errorMessageElement.textContent = "رقم هاتف ولي الأمر غير صالح.";
    googleSignUpButton.classList.add("vibrate");
    setTimeout(() => {
      googleSignUpButton.classList.remove("vibrate");
    }, 650);
...
function customError(errorCode, errorMessage) {
  // تعريف رسائل الخطأ المخصصة استنادًا إلى رموز الخطأ
  const customErrorMessages = {
    ...
    "auth/weak-password": "كلمة المرور التي قدمتها ضعيفة جدًا. يجب أن تتألف من ما لا يقل عن 8 أحرف وتحتوي على مزيج من الأحرف الكبيرة والصغيرة والأرقام والرموز الخاصة."
  };
