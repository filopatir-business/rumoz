...
async function completeProfileSignUp() {
  ...
  // استخدام directURL إذا كان موجودًا، على سبيل المثال، إعادة التوجيه بعد عملية التسجيل
  if (directURL) {
...
function handleProfilePicChange() {
  ...
  if (file) {
    ...
    RemovePictureText.textContent = "إزالة الصورة";
  }
}
